...
if __name__ == "__main__":
    ...
    print
    crowd_parser.count_crowd()
    print
    crowd_parser.count_females()
    print
    crowd_parser.count_males()
    print
    crowd_parser.count_waving()
    print
    crowd_parser.count_raising_right_arm()
    print
    crowd_parser.count_raising_left_arm()
